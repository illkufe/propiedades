...
class ContratoForm(forms.ModelForm):
	...
	metros_bodega 		= NumberField(required=False, widget=forms.TextInput(attrs={'class': 'form-control format-number text-right', 'disabled': 'disabled'}), help_text='Corresponde a la cantidad de metros cuadrados de la bodega')
