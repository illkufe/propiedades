...
class VentasForm(forms.ModelForm):
	...
	valor = NumberField(widget=forms.TextInput(attrs={'class': 'form-control format-number text-right', 'data-es-moneda': 'true', 'data-moneda': '', 'data-select': 'false'}), label='Valor', error_messages={'required': 'campo requerido'}, help_text='Valor de la Venta')
...
class LocalForm(forms.ModelForm):
	...
	metros_cuadrados 	= NumberField(widget=forms.TextInput(attrs={'class': 'form-control format-number text-right', 'data-es-moneda': 'false', 'data-moneda': '', 'data-select': 'false'}), error_messages={'required': 'campo requerido'}, help_text='Metros Cuadrados del Local')
	metros_lineales 	= NumberField(required=False, widget=forms.TextInput(attrs={'class': 'form-control format-number text-right', 'data-es-moneda': 'false', 'data-moneda': '', 'data-select': 'false'}), error_messages={'required': 'campo requerido'}, help_text='Metros Lineales del Local')
	metros_compartidos 	= NumberField(required=False, widget=forms.TextInput(attrs={'class': 'form-control format-number text-right', 'data-es-moneda': 'false', 'data-moneda': '', 'data-select': 'false'}), error_messages={'required': 'campo requerido'}, help_text='Metros Compartidos del Local')
	metros_bodega 		= NumberField(required=False, widget=forms.TextInput(attrs={'class': 'form-control format-number text-right', 'data-es-moneda': 'false', 'data-moneda': '', 'data-select': 'false'}), error_messages={'required': 'campo requerido'}, help_text='Metros de Bodega del Local')
...
class ElectricidadForm(forms.ModelForm):
	...
	potencia 			= NumberField(widget=forms.TextInput(attrs={'class': 'form-control text-right'}), help_text='Potencia de Medidor Electricidad')
	potencia_presente 	= NumberField(widget=forms.TextInput(attrs={'class': 'form-control text-right'}), help_text='Potencia Presente Medidor Electricidad')
	potencia_fuera 		= NumberField(widget=forms.TextInput(attrs={'class': 'form-control text-right'}), help_text='Potencia Fuera Medidor Electricidad')
...
class AguaForm(forms.ModelForm):
	...
	potencia = NumberField(widget=forms.TextInput(attrs={'class': 'form-control text-right'}), help_text='Potencia Medidor Agua')
...
class GasForm(forms.ModelForm):
	...
	potencia = NumberField(widget=forms.TextInput(attrs={'class': 'form-control text-right'}), help_text='Potencia Medidor Gas')
