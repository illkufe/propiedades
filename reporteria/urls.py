...
urlpatterns = [
	...
	url(r'^reportes/ingreso-activo/metros/$', csrf_exempt(views.REPORTE_INGRESO_ACTIVO_METROS.as_view()),name='reporte_ingreso_activo_metros'),
	url(r'^reportes/excel/$', csrf_exempt(views.REPORTE_INGRESO_ACTIVO_METROS.as_view()),name='reporte_ingreso_activo_metros'),
	url(r'^reportes/pdf/$', csrf_exempt(views.REPORTE_INGRESO_ACTIVO_METROS.as_view()),name='reporte_ingreso_activo_metros'),
